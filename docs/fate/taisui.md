...
- 每逢年底，“明年犯太岁生肖”的说法总会在网络上流传，伴以“我属X，明年要完了”“求化解太岁方法”一类的焦虑。本页把太岁这一概念的来龙去脉讲清楚：**它究竟是什么、“犯太岁”是否等于倒霉、传统的判断依据又是什么。**
- 太岁（又称岁神、岁星）是中国传统文化中主宰一年吉凶祸福的岁神，其判断体系基于**干支纪年法**与**六十甲子轮值**的规则，结合天文观测与民俗信仰而形成。
- 需要先说明基本态度：太岁属传统历法与民俗信仰的范畴。**“犯太岁”并不等于必然不顺**，它描述的是生肖（地支）与当年干支之间的一种关系，吉凶仍须结合具体情形看待，也不必为“化解”而付出高昂代价。
...
- 了解太岁文化，不是为了制造焦虑，而是为了在理解传统的基础上更清醒地安排生活。
- **太岁不是凶神**，而是当年的"值岁"干支，其作用更像一个提示：这一年与之相冲相刑的生肖，处在关系较紧张的位置上。
- **犯太岁不等于倒霉**。它只表示生肖与太岁之间构成了值、冲、刑、害、破中的某一种关系；是吉是凶，仍要看这股关系落在具体的人事与处境上。相反，**合太岁也不必然大吉**。
- **化解不必花钱**。传统命理与民俗中，调整心态、留意行事节奏、与人为善，才是根本之道；以"必须请符化解"为由索取高额费用的，应当警惕。
- 与太岁相关的**合冲刑害原理**，本站在《[地支关系：合冲刑害](/fate/dizhi-relation)》一篇中有完整梳理，可对照阅读。
- 一句常被引用的传统态度："**命由己造，福自我求**"。
